...
const customDropdownTheme: CustomFlowbiteTheme['dropdown'] = {
  ...
  floating: {
    ...
    header:
      'block px-4 py-2 bg-[#B5BEE3] text-sm text-gray-700 font-bold hover:bg-white',
    item: {
      container: ' hover:bg-white',
      base: 'flex w-full border-t-2 border-primary cursor-pointer items-center justify-start px-4 py-2 text-sm font-bold text-gray-700 bg-white focus:outline-none hover:bg-white',
    },
    target:
